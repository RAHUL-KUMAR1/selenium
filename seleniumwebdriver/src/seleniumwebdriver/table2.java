 ...
 sl9.selectByVisibleText(i);
   ...
   String wd=sr.getText();
    ...
    sl11.selectByVisibleText("Subject *");
                      ...
                      sl13.selectByVisibleText("Billing Address *");
                     ...
                     sl14.selectByVisibleText("Customer No");
                     ...
                     sl15.selectByVisibleText("Shipping Address *");
                     ...
                     sl16.selectByVisibleText("Invoice No");
                     ...
                     sl17.selectByVisibleText("Contact Name");
                    ...
                    sl18.selectByVisibleText("Status");
   ...
   String wd1=sr1.getText();
    ...
    ////a[text()='Assigned To']
    ////a[text()='Billing Address']
    ////a[text()='Shipping Address']
    ////td[text()='Action']
     ////table[@class='lvt small']/tbody/tr[1]
        //table[@class='lvt small']/tbody/tr[1]/td[1]
 /* String s="Actio";
  boolean flag=false;
    String a;
   List <WebElement> qw=driver.findElements(By.xpath("//table[@class='lvt small']/tbody/tr[1]"));
